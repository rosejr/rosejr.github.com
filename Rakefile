...
task :switch_theme, :theme do |t, args|
  ...
  abort("rake aborted: './_includes/themes/#{args.theme}' directory not found.") unless File.directory?(theme_path)
  abort("rake aborted: './_layouts' directory not found.") unless File.directory?(layouts_path)
